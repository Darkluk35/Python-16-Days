...
#2. Los ejercicios que contienen el la función input() deben ser probados con el botón:
#"Ejecutar pruebas".  Ya que el botón "Ejecutar código" arrojará el siguiente error: "EOF when reading a line".

print(input("What country do you live in?"))